...
<div class="max-w-2xl space-y-6">
		...
		<CardContent>
			<form class="space-y-4">
				<div class="space-y-2">
					...
					<Input id="name" value={data.user.name} />
				</div>
				<div class="space-y-2">
	...
	<Card>
		<CardHeader>
			...
			<CardDescription>外部カレンダーと連携して空き時間を自動取得します</CardDescription>
		</CardHeader>
		<CardContent class="space-y-4">
			<div class="flex items-center justify-between rounded-lg border p-4">
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<p class="text-sm text-muted-foreground">未連携</p>
					</div>
				</div>
			...
			<div class="flex items-center justify-between rounded-lg border p-4">
				<div class="flex items-center gap-3">
					...
					<div>
						<p class="font-medium">Microsoft Outlook</p>
						<p class="text-sm text-muted-foreground">未連携</p>
					</div>
				</div>
				<Button variant="outline">連携する</Button>
